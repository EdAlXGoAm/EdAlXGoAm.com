...
const HotDog = ({ index, comanda, platillo, platillo_espacios, status }) => {
    const pizzaOptions = [
        'Sencillo',
        'Q Oaxaca',
        'Q Manchego',
    ...
    return (
        <div>
            ...
            <div className="row">
                <div className="col">
                    <ToogleButton_CheckButtons index={index} platillo='Burguer' tipo_ingrediente='vegetales' ingredientes_checkbutton={vegetales} despliegue='horizontal' />
                </div>
                </div>
            <div className="row">
                <div className="col">
